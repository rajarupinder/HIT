<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAllUsers.aspx.cs" Inherits="Admin_ViewAllUsers" MasterPageFile="~/Admin/AdminMaster.master" Title="AllUsers"%>


<asp:Content ContentPlaceHolderID="content_body" ID="ViewAllUsers" runat="server" >

    <link href="css/ViewAllUsers.css" rel="stylesheet" />
    <script src="Scripts/jquery-1.10.2.js" type="text/javascript"></script>
    <script src="Scripts/ViewAllUsers.js"></script>
    ...
    <div>
        ...
        <div id="div_main_contianer">            <!-- The main container--> 
            ...
            <div id="div_middle">                <!-- The Middle Body --> 
                ...
                <div id="div_userlist_container">           <!-- User list container -->
